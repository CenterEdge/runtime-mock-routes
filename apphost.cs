...
var mocks = builder.AddJavaScriptApp("mocks", "./", "serve")
    .WithEnvironment("LOG_MOCK_REQUESTS", "true")
    .WithHttpEndpoint(port: 8080, env: "RUNTIME_MOCK_ROUTES_PORT")
    .WithUrlForEndpoint("http", url => url.Url = "/api/test")
    .WithHttpsEndpoint(port: 8443, env: "RUNTIME_MOCK_ROUTES_HTTPS_PORT")
    .WithUrlForEndpoint("https", url => url.Url = "/api/test")
